...
{
    public class BoneTables
    {
        public static readonly Dictionary<int, string> GH3_SINGER_NUM = new Dictionary<int, string>
        {
            {0, "control_root"},
        ...
        public static readonly Dictionary<int, string> GHA_SINGER_NUM = new Dictionary<int, string>
        {
            {0, "control_root"},
            {1, "bone_pelvis"},
            {2, "bone_thigh_l"},
        ...
        public static readonly Dictionary<int, string> STEVE_NUM = new Dictionary<int, string>
        {
            {0, "control_root"},
            {1, "bone_pelvis"},
            {2, "bone_thigh_l"},
        ...
        public static readonly Dictionary<int, string> DMC_NUM = new Dictionary<int, string>
        {
            {0, "control_root"},
            {1, "bone_pelvis"},
            {2, "bone_thigh_l"},
        ...
        public static readonly Dictionary<int, string> WT_NUM = new Dictionary<int, string>
        {
            {0, "control_root"},
            {1, "bone_pelvis"},
