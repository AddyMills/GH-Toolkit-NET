...
namespace GH_Toolkit_Core.Audio.Audio_Effects
{
    /*
         Code below is from Mark Heath's article on NAudio Effect Frameworks
         https://www.markheath.net/post/limit-audio-naudio
         
    */
    public class SoftLimiter : EffectBase
    {
        public override string Name => "Soft Clipper/Limiter";

        public EffectParameter Boost { get; } = new EffectParameter(0f, 0f, 18f, "Boost");
        public EffectParameter Brickwall { get; } = new EffectParameter(-7.0f, -8.0f, 1f, "Output Brickwall(dB)");
